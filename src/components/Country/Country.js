...
class Country extends React.Component {
  ...
  constructor(){
    super();
    this.state={ dataLoadingStatus: 'loading', chartData: [],tableData: [],smTableData: []};
  
  }

    reset (){
      this.setState({dataLoadingStatus: 'loading', chartData: [],tableData: [],smTableData:[]});
    }
  ...
  render(){
    const {dataLoadingStatus, chartData, tableData,smTableData}= this.state;
  return (
    <>
  ...
  {({ width }) => <>
  {'Azerbaizan'}
  <p onClick={this.handleToggle}>Back</p>
